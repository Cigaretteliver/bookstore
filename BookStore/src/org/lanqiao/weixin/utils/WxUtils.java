...
public class WxUtils {
	public static final String TOKEN = "lanqiao";
	public static final String APPID = "wxb6777fffdf5b64a4";
	public static final String APPSECRET = "6b55d3bb4d9c5373c8a30915d900ca13";
	...
	//客服
	public static final int MODE_KEFU=3;
	...
	public static JSONObject httpRequestSendFile(String dstUrl,File file) throws MalformedURLException{
		...
		try {
			...
			if (file != null && file.exists()) {
				...
				urlConnection.addRequestProperty("filelength", String.valueOf(file.length()));
				...
				return JSONObject.fromObject("{\"errmsg\":\"文件不存在\"}");
			}
			// 准备接收数据
	...
	public static String getBasePath(String uri) {
		// a.jpg
		// http://www.6sdd.com/BookStore/a.jpg
		return "http://www.6sdd.com/BookStore/" + uri;
	}

	public static String getUrl(Book b) {
		return getBasePath("book/bookDetail?id=") + b.getId();
	}
