...
public class BookServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			Method m = BookServlet.class.getDeclaredMethod(methodName, HttpServletRequest.class,
	...
	public void listAll(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String orderby = request.getParameter("orderby") == null ? "10" : request.getParameter("orderby");
	 ...
	 * 
	 * @author 教学部-罗召勇
	 * @time 2017年2月12日 下午12:47:11
	 * @param request
	 * @param response
	 * @throws ServletException
	 * @throws IOException
	 */
	public void getKeys(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String key = request.getParameter("key");
		KeyDao dao = new KeyDao();
		if (key != null && !key.equals("")) {
			List<Keyword> keys = dao.getAllByKey(key);
			if (keys != null) {
